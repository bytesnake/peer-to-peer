...
impl ResolvePeers {
    ...
    pub fn poll(&mut self) -> Result<Async<Option<(PeerCodecRead, PeerCodecWrite, PeerPresence)>>, io::Error> {
...
pub enum Peer {
    ...
    WaitForJoin((PeerCodecRead, PeerCodecWrite)),
    Ready
}
...
impl Future for Peer {
    type Item=(PeerCodecRead, PeerCodecWrite, PeerPresence);
    type Error=io::Error;
...
pub fn new(socket: TcpStream) -> (PeerCodecRead, PeerCodecWrite) {
